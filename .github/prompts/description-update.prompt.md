...
- `/tmp/description/it/REDDIT_POST.md` -> post in italiano per la condivisione del progetto su reddit e altre piattaforme. Discorsivo, pochi esempi di utilizzo, invito al confronto.
...
- `/tmp/description/en/REDDIT_POST.md` -> post in inglese per la condivisione del progetto su reddit e altre piattaforme. Discorsivo, pochi esempi di utilizzo, invito al confronto.
